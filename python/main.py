# Main file contains Welcome Screen and Main Menu features
...
def main(): # Main Function
    ...
    run_main_menu_loop()    # Run Main Menu Loop

def run_main_menu_loop():   # Run Main Menu Loop Function
...
if __name__ == "__main__":  # Main Function Loader
    main()